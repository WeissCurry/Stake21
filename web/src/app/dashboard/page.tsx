...
const DashboardPage = () => {
    ...
    const transactions = [
        { type: "Daily Reward Received", amount: "+0.0004 ETH", date: "Oct 9, 2025", positive: true },
        { type: "Daily Reward Received", amount: "+0.0004 ETH", date: "Oct 8, 2025", positive: true },
        { type: "ETH Staked", amount: "3.00 ETH", date: "Oct 5, 2025", positive: false },
        { type: "Daily Reward Received", amount: "+0.0003 ETH", date: "Oct 4, 2025", positive: true },
        { type: "ETH Staked", amount: "2.25 ETH", date: "Oct 1, 2025", positive: false },
    ];
        ...
        <div className="min-h-screen bg-background pb-24">
            ...
            <header className="bg-gradient-hero shadow-medium text-white">
                <div className="max-w-md mx-auto px-6 py-8">
                    ...
                    <p className="text-sm opacity-90">Monitor your investments and earnings</p>
                </div>
            </header>
            ...
            <main className="max-w-md mx-auto px-6 -mt-4 space-y-6">
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <p className="text-xs text-slate-500 text-center mt-3">
                        Reward growth over the last 7 days
                    </p>
                    </div>
                </div>
                </div>
